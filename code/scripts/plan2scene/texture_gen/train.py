...
if __name__ == "__main__":
    ...
    parser = argparse.ArgumentParser(
        description="Train the texture synthesis stage of Plan2Scene.")
    parser.add_argument("output_path", type=str, nargs=1,
                        help="Output path to save train logs and checkpoints.")
    parser.add_argument("texture_synth_config_path", type=str,
                        nargs=1, help="Path to texture synthesis config file.")
    parser.add_argument("--save-model-interval", type=int, default=50,
                        help="Epoch interval between periodic checkpoint saves.")
    parser.add_argument("--dataset-path", type=str, default=None,
                        help="Override path to textures dataset.")
    ...
    shutil.copyfile(texture_synth_config_path,
                    osp.join(output_path, "config.yml"))
